...
def _render_ai_settings(payload: dict, container: Optional[DeltaGenerator] = None) -> None:
    ...
    with target.form("ai_settings_form"):
        ...
        submitted = target.form_submit_button("Save AI Configuration")
