...
try:  # pragma: no cover - optional dependency guard for tests/minimal installs
    import requests
    from requests import Response, Session
    from requests.adapters import HTTPAdapter
    from urllib3.util import Retry
    RequestException = requests.RequestException
except Exception:  # pragma: no cover - allow importing without requests installed
    ...
    class RequestException(Exception):  # type: ignore[misc]
...
class PaystackClient:
    ...
    def _build_session(self) -> Session:
        ...
        if requests is None or HTTPAdapter is None or Retry is None:
            raise RuntimeError("The 'requests' package is required for Paystack API access.")
    ...
    def _request(self, method: str, path: str, **kwargs: Any) -> Any:
        ...
        except RequestException as exc:  # pragma: no cover - network handling
